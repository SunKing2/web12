...
@NamedQueries({
    ...
    , @NamedQuery(name = "Question.findByAge", query = "SELECT q FROM Question q WHERE q.age = :age")})
public class Question implements Serializable {
    ...
    public Question(Integer id, String question, String answer, int rating, int age) {
        this.id = id;
